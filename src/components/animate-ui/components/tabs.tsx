...
// Note: This code was not written by me. This was found at https://animate-ui.com/ which is an open-source project
// for creating animations in React with Shadcn and Motion.
...
function TabsList({
  ...
  return (
    <MotionHighlight
      controlledItems
      className={cn("dark:bg-input/30 rounded-lg shadow-sm", activeClassName)}
      value={activeValue}
      transition={transition}
    >
      <div
